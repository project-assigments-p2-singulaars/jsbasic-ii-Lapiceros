...
if ((typeof value === 'number') || ( typeof value === 'string')) {
    console.log(`Es un ${typeof(value)}`);
} else {
...
//Escribe tu código aquí
 let saludo = (nombre) => `Hola ${nombre}, que dice mi arma?`;
 console.log(saludo('Juan'));
 console.log(saludo('illo'));
 console.log(saludo('kike'));
...
console.log(calcularAreaRectangulo(23, 234));
console.log(calcularAreaRectangulo(123, 213));
console.log(calcularAreaRectangulo(34, 768));
